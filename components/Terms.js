            ...
            <div className="techwave_fn_privacy_page">
                ...
                <div className="privacypage">
                    <div className="container small">
                        <h4 className="fn__animated_text">Ownership of Site; Agreement to Terms of Use</h4>
                        <p>Suggested text: Our website address is: https://frenify.com/work/envato/frenify/html/techwave/1/</p>
                        <hr />
                        <h4 className="fn__animated_text">Content</h4>
                        ...
                        <hr />
                        <h4 className="fn__animated_text">Your Use of the Site</h4>
                        ...
                        <hr />
                        <h4 className="fn__animated_text">Purchases; Other Terms and Conditions</h4>
                        ...
                        <hr />
                        <h4 className="fn__animated_text">Accounts, Passwords and Security</h4>
                        ...
                        <hr />
                        <h4 className="fn__animated_text">Violation of These Terms of Use</h4>
                        ...
                        <hr />
                        <h4 className="fn__animated_text">Miscellaneous</h4>
